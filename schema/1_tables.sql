...
CREATE TABLE `DataCollectionGroup` (
  ...
  `experimentType` enum('EM','SAD','SAD - Inverse Beam','OSC','Collect - Multiwedge','MAD','Helical','Multi-positional','Mesh','Burn','MAD - Inverse Beam','Characterization','Dehydration','Still','SSX-Chip','SSX-Jet','LineScan','GphNative') DEFAULT NULL,
...
--
-- Table structure for table `ProposalDataDeletionRequest`
--

DROP TABLE IF EXISTS `ProposalDataDeletionRequest`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `SSXProcessingResult` (
  ...
  `comments` varchar(100) DEFAULT NULL,
  `nbCrystals` int(11) DEFAULT NULL COMMENT 'Number of crystals',
...
CREATE TABLE `SSXProcessingResultAttachment` (
  ...
  `fileType` enum('Real-time processing results','Processing results') NOT NULL,
  `createdTimeStamp` timestamp NOT NULL DEFAULT current_timestamp(),
  `lastUpdate` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'last update timestamp',
