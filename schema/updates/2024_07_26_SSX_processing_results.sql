...
CREATE TABLE `SSXProcessingResult`(
    `ssxProcessingResultId` int(11) unsigned auto_increment PRIMARY KEY COMMENT 'Primary key',
...
CREATE TABLE `SSXProcessingResultAttachment`(
    `ssxProcessingResultAttachmentId` int(11) unsigned auto_increment PRIMARY KEY COMMENT 'Primary key',
